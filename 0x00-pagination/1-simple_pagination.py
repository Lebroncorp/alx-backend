...
def index_range(page: int, page_size: int) -> Tuple[int, int]:
    ...
    containing the start and end indices corresponding to the
    range of indices to return in a list for those particular
...
class Server:
    ...
    def get_page(self, page: int = 1, page_size: int = 10) -> List[List]:
        """
        this function takes 2 int args page = 1
        and page_size = 10
