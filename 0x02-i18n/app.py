...
def get_locale() -> str:
    """
    this method checks the URL parameter
    for locale variable and
    force the Locale of the app
    """
...
def before_request():
    """
    this function forces this method
    to be executed before any other
    """
    g.user = get_user()
